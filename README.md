...
- Temporary storage: `server/tmp/uploads/`

### API Rate Limiting
Configure rate limits in `server/app.js` for different endpoint groups

### Database Cleanup
Use `server/cleanDB.js` to clean development database
...
- Check port numbers match (5173 for client)
- Clear browser cache and cookies

## Future Enhancements

- Real-time WebSocket integration for chat rooms
- Push notifications for comments/follows
- Stories feature (24-hour slideshow)
...
- **Daniel Fleshler** - [GitHub](https://github.com/DanielFleshler)
- **Iegor Kovalov**
...
Built with modern web technologies and best practices for scalable social media applications.
